    ...
    (_) => Column(
      children: [
        SessionListTile(
          ...
          avatar: const IdentityAvatar(identifier: 'example-idle', size: 48),
          statusLabel: 'Idle',
          timestamp: '12m',
          onTap: () {},
          onLongPress: () {},
        ...
        SessionListTile(
          ...
          avatar: const IdentityAvatar(identifier: 'example-active', size: 48),
        ...
        SessionListTile(
          identifier: 'example-blocked',
          title: 'Waiting on a permission decision',
          project: 'example-project',
          avatar: const IdentityAvatar(identifier: 'example-blocked', size: 48),
        ...
        SessionListTile(
          identifier: 'example-unread',
          title: 'Finished while you were away',
          project: 'example-project',
          avatar: const IdentityAvatar(identifier: 'example-unread', size: 48),
          statusLabel: 'Idle',
          unread: true,
          timestamp: '5m',
          onTap: () {},
        ),
        const ArchiveToggle(hidden: true, onPressed: null),
        const SessionListTile(
          identifier: 'example-offline',
          title: 'Unavailable session',
          project: 'another-project',
          avatar: IdentityAvatar(identifier: 'example-offline', size: 48),
          statusLabel: 'Offline',
          faded: true,
          timestamp: '2h',
          onTap: null,
