...
///
/// Prompt was answering the same question in three shapes — one per screen —
/// the quietest of which was a single grey sentence floating mid-screen, which
/// reads as a loading state rather than an answer.
class EmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Centred when there is room, scrollable when there is not. Enlarged text
    // turns three short lines into a dozen, and an empty state is often handed
    // a fixed slot; a bare scroll view would pin it to the top even on a screen
    // with space to spare.
